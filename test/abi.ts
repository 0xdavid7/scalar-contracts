export const ERC20CrossChainABI = [
  {
    type: "constructor",
    inputs: [
      { name: "gateway_", type: "address", internalType: "address" },
      { name: "gasReceiver_", type: "address", internalType: "address" },
  ...
  },
  {
    ...
    name: "gasService",
    inputs: [],
    outputs: [{ name: "", type: "address", internalType: "contract IAxelarGasService" }],
    stateMutability: "view",
  },
  {
    type: "function",
    name: "gateway",
    inputs: [],
    outputs: [{ name: "", type: "address", internalType: "contract IAxelarGateway" }],
    stateMutability: "view",
  },
  {
    type: "function",
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: "destinationContractAddress", type: "address", internalType: "address" },
      { name: "amount", type: "uint256", internalType: "uint256" },
      { name: "encodedMetadata", type: "bytes", internalType: "bytes" },
    ],
    outputs: [],
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: "newImplementationCodeHash", type: "bytes32", internalType: "bytes32" },
  ...
  },
  {
    ...
    name: "FalseSender",
    inputs: [
      { name: "sourceChain", type: "string", indexed: false, internalType: "string" },
  ...
  },
  {
    ...
    name: "TransferRemote",
    inputs: [
      { name: "destinationChain", type: "string", indexed: false, internalType: "string" },
      { name: "destinationContractAddress", type: "address", indexed: false, internalType: "address" },
  ...
  { type: "error", name: "InvalidAddressString", inputs: [] },
  ...
  { type: "error", name: "NotApprovedByGateway", inputs: [] },
